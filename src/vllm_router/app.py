...
def initialize_all(app: FastAPI, args):
    ...
    if args.service_discovery == "static":
        initialize_service_discovery(
            ...
            endpoint_prefixes=(
                json.loads(args.static_endpoint_prefixes)
    ...
    initialize_routing_logic(
        ...
        kv_aware_per_model_thresholds=args.kv_aware_per_model_thresholds,
        prefix_aware_match_threshold=args.prefix_aware_match_threshold,
        prefix_aware_per_model_config=args.prefix_aware_per_model_config,
        tokenizer_model_names=args.tokenizer_model_names,
